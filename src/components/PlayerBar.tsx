        ...
        <div className="fixed inset-0 z-50 flex flex-col text-white">
          ...
          <div className="relative z-10 flex h-full flex-col">
            <div className="flex items-center justify-between px-4 py-4 sm:px-6">
              <div>
                <p className="text-xs uppercase tracking-[0.16em] text-gray-400">Now playing</p>
            ...
            <div className="flex flex-1 flex-col items-center justify-center px-4 pb-6 sm:px-6">
              <img
                src={track.albumArt || 'https://placehold.co/512x512/png'}
                alt={track.title}
                className="h-72 w-72 rounded-3xl object-cover shadow-2xl sm:h-80 sm:w-80"
              />
              ...
              <div className="mt-8 w-full max-w-4xl overflow-hidden rounded-3xl border border-white/10 bg-black/30 p-4 backdrop-blur-md sm:p-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
                  <div className="w-full overflow-hidden rounded-2xl border border-white/10 bg-black lg:w-[420px]">
